...
export const ProductListTopSaleText = styled.div`
  font-size: 18px;
  line-height: 52px;
`;

export const ProductListTopSoldText = styled.div`
  font-size: 18px;
  line-height: 52px;
`;
...
export const ProductListbottomPicture = styled.div`
  width: 160px;
  height: 160px;
...
export const TodayProductPicture = styled.div`
  padding-top: 4px;
  width: 60px;
  height: 60px;
